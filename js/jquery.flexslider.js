...
(function ($) {
  ...
  $.flexslider = function(el, options) {
    ...
    methods = {
      ...
      directionNav: {
        setup: function() {
          var directionNavScaffold = $('<ul class="' + namespace + 'direction-nav"><li class="' + namespace + 'nav-prev"><a class="' + namespace + 'prev" href="#"><i class="fa fa-chevron-left fa-2" aria-hidden="true"></i></a></li><li class="' + namespace + 'nav-next"><a class="' + namespace + 'next" href="#"><i class="fa fa-chevron-right fa-2" aria-hidden="true"></i></a></li></ul>');
